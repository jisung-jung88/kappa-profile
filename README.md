...
│   ├── fig8/                             # Appendix: schedule ablation
│   └── fig9/                             # Appendix: day-to-day repeatability
│
└── data/
...
```bash
# Fig.8: Schedule ablation (blocked vs interleaved)
...
# Fig.9: Day-to-day repeatability
python figures/fig9/make_fig9.py \
  --counts data/qpu/qpu_counts.json \
  --out-dir outputs/fig9 \
