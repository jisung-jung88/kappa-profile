# make_fig9.py
# CLI wrapper to generate Appendix Fig. 9 (Day1 vs Day2 repeatability)
...
from fig9_data import Fig5AnalysisConfig, compute_fig9_day_products, build_fig9_manifest
from fig9_plot import plot_fig9, get_paper_style_manifest_rcparams
...
def main() -> None:
    ...
    day1 = compute_fig9_day_products(
    ...
    day2 = compute_fig9_day_products(
        counts_json=counts_path,
        cfg=cfg,
    ...
    (cache_dir / "fig9_day1_summary.csv").write_text(day1_summary.to_csv(index=False))
    (cache_dir / "fig9_day2_summary.csv").write_text(day2_summary.to_csv(index=False))
    (cache_dir / "fig9_day1_deltaV.csv").write_text(day1_delta.to_csv(index=False))
    (cache_dir / "fig9_day2_deltaV.csv").write_text(day2_delta.to_csv(index=False))

    # Render
    out_pdf = out_dir / "figure_9_repeatability.pdf"
    out_png = None if args.no_png else str(out_dir / "figure_9_repeatability.png")
    ...
    outputs = {
        ...
        "figure_png": str(out_dir / "figure_9_repeatability.png") if out_png else None,
        "day1_summary_csv": str(cache_dir / "fig9_day1_summary.csv"),
        "day2_summary_csv": str(cache_dir / "fig9_day2_summary.csv"),
        "day1_delta_csv": str(cache_dir / "fig9_day1_deltaV.csv"),
        "day2_delta_csv": str(cache_dir / "fig9_day2_deltaV.csv"),
    }

    manifest = build_fig9_manifest(
        counts_json=counts_path,
        cfg=cfg,
    ...
    manifest_path = out_dir / "figure_9_manifest.json"
