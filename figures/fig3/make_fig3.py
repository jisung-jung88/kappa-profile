...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--fig-w", type=float, default=10.0, help="Figure width in inches (default: 10.0)")
    p.add_argument("--fig-h", type=float, default=3.6, help="Figure height in inches (default: 3.6)")
